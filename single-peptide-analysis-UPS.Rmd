...
#for (n in 1:nrow(all_results)){
 if (n != 16){
  ...
  #paths$em.extraneous.to.ancestors <- paste(map_paths(em_extraneous, em_ancestors), collapse="; ")
  paths$mg.extraneous.to.ancestors <- paste(map_paths(mg_extraneous, mg_ancestors), collapse="; ")
  #paths$em.extraneous.to.ancestors.kids <- paste(map_paths(em_extraneous, em_ancestors_kids), collapse="; ")
  paths$mg.extraneous.to.ancestors.kids <- paste(map_paths(mg_extraneous, mg_ancestors_kids), collapse="; ")
  #paths$em.uniprot.to.ancestors <- paste(map_paths(em_buni, em_ancestors), collapse="; ")
  #paths$mg.uniprot.to.ancestors <- paste(map_paths(mg_buni, mg_ancestors), collapse="; ")
  #paths$em.uniprot.to.descendants <- paste(map_paths(em_buni, em_descendants), collapse="; ")
  paths$mg.uniprot.to.descendants <- paste(map_paths(mg_buni, mg_descendants), collapse="; ")
...
```
```{r}
result <- str_split(paths$em.extraneous.to.ancestors.kids, '; ', simplify=TRUE)
