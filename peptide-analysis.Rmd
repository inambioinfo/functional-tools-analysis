...
ups2 <- filter(ups2_raw, grepl("ups", ups2_protein)) %>%
  extract('ups2_protein','amount', regex = '.*(P[0-9]+)ups.*', remove = FALSE)
ups2
str_match('LALBA_HUMAN; P00709ups', '.*(P[0-9]+)ups,*')[2]
str_match('ALBU_BOVIN; ALBU_HUMAN; P02768ups', '.*(P[0-9]+)ups,*')[2]
